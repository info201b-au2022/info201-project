...
### Conclusion
At the start of the project, our group did not think much about the implications of factors such as age or bodycam use when thinking of police brutality, and the main reason we thought of the effect of one's race is because of the recent societal movements to raise awareness of such issues, such as Black Lives Matters. Through our research and data cleaning, wrangling, and visualizations, patterns began to form, and we've determined that race and age play a large factor in who becomes a victim of police brutality and does not, as well as the fact that for most of these horrifying events, the police bodycams are not turned on, perhaps in order to conceal the influence of such factors. While we have successfully answered some questions, many more pop up that cannot be answered with the information provided in this single dataset. Though our dataset contains information only up until 2018, we see many of these patterns still present today, such as in the earlier example of the events leading to BLM. We hope that through our research we can help raise more awareness of these issues and continue to push for further social change.
